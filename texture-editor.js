(() => {
  ...
  function buildDirectPrompt() {
    ...
    return [
      ...
      "",
      "Every UV coordinate and boundary from the original must be multiplied by exactly " + scale + ".",
      "",
      "Example:",
      "original UV boundary: x = " + exampleX + ", y = " + exampleY,
      "high-resolution equivalent: x = " + (exampleX * scale) + ", y = " + (exampleY * scale),
      "",
      "Preserve these scaled boundaries with extremely high precision.",
      "",
      "DO NOT simply enlarge the original pixels.",
      "DO NOT make every original texel into one giant flat-colored " + scale + " × " + scale + " square.",
      "Use the extra resolution to CREATE NEW FINE DETAIL inside the corresponding UV regions.",
      "",
      "",
      "==================================================",
      "3. VISUAL QUALITY",
      ...
      "",
      "Use fine material detail, subtle surface variation, small scratches, fabric weave, leather grain, tiny seams, stitching, controlled wear, subtle dirt, material-specific highlights, small color variations, detailed shading, carefully painted edges, local ambient occlusion and believable surface depth.",
      "",
      "Materials must remain visually distinguishable, but do not make the result photorealistic.",
      "Think: premium HD Minecraft resource-pack texture, not a photograph pasted onto a Minecraft model.",
      "",
      "",
      "==================================================",
      ...
      "==================================================",
      "",
      "AVOID giant blocky pixels, obvious 8-bit clusters, checkerboard shading, noisy random pixels, accidental jagged edges, low-resolution pixel art and nearest-neighbor enlargement artifacts.",
      "",
      "The image should appear detailed and clean at its native " + target.width + " × " + target.height + " resolution.",
      "",
      "",
      "==================================================",
      "5. UV SAFETY",
      "==================================================",
      "",
      "Preserve exact UV island proportions, relative UV coordinates, face orientations, atlas aspect ratio, transparent regions and separation between unrelated body parts.",
      "",
      "Never allow information from one UV island to bleed into another.",
      ...
      "==================================================",
      "",
      "Where neighboring faces belong to the same 3D body part, continue materials naturally across cube edges.",
      "Do NOT move faces to achieve continuity. Paint continuity INSIDE the existing mapping.",
      "",
      "",
      "==================================================",
      "7. TRANSPARENCY",
      ...
      "",
      "Do not add backgrounds, shadows behind the atlas, decorative graphics, labels, text, UV guides or outlines around UV islands.",
      "",
      "",
      "==================================================",
      "8. OUTPUT FORMAT",
      ...
      "No character render. No 3D preview. No mockup. No comparison image. No grid. No labels.",
      "",
      "",
      "==================================================",
      "FINAL VALIDATION",
      "==================================================",
      "",
      "Conceptually overlay the output onto the reference texture.",
      "The atlas organization must be identical.",
      "Only the artistic appearance and the resolution are allowed to change.",
